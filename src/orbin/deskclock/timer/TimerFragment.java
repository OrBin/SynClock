...
import static orbin.deskclock.FabContainer.UpdateType.DISABLE_BUTTONS;
import static orbin.deskclock.FabContainer.UpdateType.FAB_AND_BUTTONS_SHRINK_AND_EXPAND;
...
public final class TimerFragment extends DeskClockFragment {
    ...
    private static final String EXTRA_TIMER_SETUP = "orbin.deskclock.action.TIMER_SETUP";
