...
import orbin.deskclock.data.City;
...
import orbin.deskclock.worldclock.CitySelectionActivity;

import java.util.List;
import java.util.Set;

import static orbin.deskclock.uidata.UiDataModel.Tab.CLOCKS;
...
public class HandleDeskClockApiCalls extends Activity {
    ...
    private static final String ACTION_PREFIX = "orbin.deskclock.action.";
    ...
    public static final String EXTRA_CITY = "orbin.deskclock.extra.clock.CITY";
    ...
    public static final String EXTRA_TIMER_ID = "orbin.deskclock.extra.TIMER_ID";

    // Describes the entity responsible for the action being performed.
    public static final String EXTRA_EVENT_LABEL = "orbin.deskclock.extra.EVENT_LABEL";
