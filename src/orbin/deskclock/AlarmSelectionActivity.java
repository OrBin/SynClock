...
import orbin.deskclock.widget.selector.AlarmSelection;
import orbin.deskclock.widget.selector.AlarmSelectionAdapter;
...
public class AlarmSelectionActivity extends ListActivity {
    ...
    public static final String EXTRA_ALARMS = "orbin.deskclock.EXTRA_ALARMS";
