...
import orbin.deskclock.provider.ClockContract;
...
import static orbin.deskclock.data.Timer.State.PAUSED;
import static orbin.deskclock.data.Timer.State.RESET;
import static orbin.deskclock.data.Timer.State.RUNNING;
